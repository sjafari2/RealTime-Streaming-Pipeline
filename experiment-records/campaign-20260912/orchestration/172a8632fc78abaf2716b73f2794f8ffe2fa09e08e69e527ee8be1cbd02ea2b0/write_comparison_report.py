...
lines=['# Preliminary action comparison','',f"Status: **{index.get('status','recorded pairs')}**. Each pair below uses its own matched workload seed. Short, sustained and isolated-partition episodes are analyzed separately.",'']
