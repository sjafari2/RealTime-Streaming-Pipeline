...
Managed status: **complete**. Full data: `results/run-20260912-064358/` in the active code folder; original event evidence remains on the Nautilus PVCs.
...
| Unique completions / evaluation second | 1,490.2315 |
| Recorded completion mean (ms) | 15,467.1738 |
| Recorded completion p99 (ms) | 95,579.5496 |
| Provisional 99 ms cohort deadline-miss fraction | 0.616 |
| Lag coverage fraction | 0.937 |
| Covered mean returned-position lag (offsets) | 20,994.1996 |
| Peak sampled returned-position lag (offsets) | 33,369 |
| Recorded consumer process-seconds | 4,042.8991 |
