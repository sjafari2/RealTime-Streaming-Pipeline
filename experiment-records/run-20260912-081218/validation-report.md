...
Managed status: **complete**. Full data: `results/run-20260912-081218/` in the active code folder; original event evidence remains on the Nautilus PVCs.
...
| Unique completions / evaluation second | 1,462.2333 |
| Recorded completion mean (ms) | 15,739.5592 |
| Recorded completion p99 (ms) | 62,936.0235 |
| Provisional 99 ms cohort deadline-miss fraction | 0.7992 |
| Lag coverage fraction | 0.8 |
| Covered mean returned-position lag (offsets) | 21,262.1562 |
| Peak sampled returned-position lag (offsets) | 30,021 |
| Recorded consumer process-seconds | 1,521.1893 |
| Resource request-time coverage fraction | 0.9347 |
