...
A=Path(__file__).resolve().parent;R=Path('/Users/soheila/Desktop/Thesis-26-27/code/results')
b=json.loads((A/'block/block-status.json').read_text());names=[x['run_id'] for x in b['attempts']]
