...
Frozen low-input pilot, pair A2, scheduled action none. HPA paused; initial replicas checked. This is a preliminary action comparison, not a full adaptive controller evaluation. Interpret latency with unfinished outcomes, achieved admission, coverage, deployment/ownership events and common-horizon resource requests.

Managed status: **complete**. Full data: `results/run-20260912-100910/` in the active code folder; original event evidence remains on the Nautilus PVCs.
...
| Unique completions / evaluation second | 599.7333 |
| Recorded completion mean (ms) | 178.115 |
| Recorded completion p99 (ms) | 824.9724 |
| Provisional 99 ms cohort deadline-miss fraction | 0.7272 |
| Lag coverage fraction | 0.9833 |
| Covered mean returned-position lag (offsets) | 86.9068 |
| Peak sampled returned-position lag (offsets) | 170 |
| Recorded consumer process-seconds | 1,223.1652 |
| Resource request-time coverage fraction | 0.7975 |
