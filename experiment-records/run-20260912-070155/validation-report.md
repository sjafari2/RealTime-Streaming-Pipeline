...
| Completed by drain | 717,852 |
| Unfinished by drain | 92,148 |
| Duplicate cohort completion attempts | 0 |
| Admissions / evaluation second | 1,500 |
| Unique completions / evaluation second | 1,239.6259 |
| Recorded completion mean (ms) | 56,912.0984 |
| Recorded completion p99 (ms) | 292,423.7413 |
| Provisional 99 ms cohort deadline-miss fraction | 0.8114 |
| Lag coverage fraction | 0.9963 |
| Covered mean returned-position lag (offsets) | 85,073.2639 |
| Peak sampled returned-position lag (offsets) | 154,820 |
| Recorded consumer process-seconds | 2,291.1778 |
| Resource request-time coverage fraction | 0.9687 |
