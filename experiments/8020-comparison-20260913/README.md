...
Completed on 13 September 2026: four empty rehearsals and both trials passed; original settings were restored. [Results and plots](../../experiment-records/8020-comparison-20260913/README.md). This is a new workload comparison, not a relabeling of the earlier single-partition results.
...
```bash
python3 experiments/controlled-followup-20260912/execute_block.py --static-startup --include-comparison --workload 80-20 --audit-dir /ABSOLUTE/NEW/AUDIT/DIRECTORY
```
