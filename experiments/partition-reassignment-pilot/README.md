...
Candidate workload: 900 messages/s total (300 per producer), 100-byte payload, 2,000 SHA-256 iterations, no added sleep. Production lasts 600 seconds including 60 seconds warm-up, followed by 120 seconds drain. The decision is 120 seconds after evaluation begins (180 seconds after production starts), leaving 420 seconds of continued input. These candidate values require calibration before the comparison configuration is frozen. Eight production/drain windows total 96 minutes; preparation, validation, calibration and collection are additional time.
...
1. The pilot uses explicit assignment in both the keep and redistribution arms so that assignment mechanisms remain comparable.
