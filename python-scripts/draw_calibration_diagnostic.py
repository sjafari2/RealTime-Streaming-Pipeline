...
fig.suptitle(f"Qualified pressure calibration · {m['run_id']}\n3 consumers · 60 partitions · 1,500 messages/s · 2,000 SHA-256 iterations/message",fontsize=12)
fig.supxlabel('Each consumer retained 20 partitions throughout production and drain. The input bars use exact cohort evidence;\nthe backlog curves use saved 5-second guard observations. Shared-node differences were observed, not experimentally isolated.',fontsize=8)
