...
source_paths=("/app/request-producer-data" "app/consumer-app-data" "app/app-merge-data" "app/merged-clstr-data")
selector_pods=( "producer" "consumer" "consumer" "merge")
container_names=( "producer-container" "consumer-container" "application-container" "merge-container")
