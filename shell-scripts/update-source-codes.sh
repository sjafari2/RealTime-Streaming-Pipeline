...
pods=( "producer-sts" "consumer-application-sts" "consumer-application-sts" "merge-sts" "request-sts")
destinations=( "./src/producer" "./src/consumer" "./src/application" "./src/merge" "./src/request")
containers=( "producer-container" "consumer-container" "application-container" "merge-container" "request-container")
